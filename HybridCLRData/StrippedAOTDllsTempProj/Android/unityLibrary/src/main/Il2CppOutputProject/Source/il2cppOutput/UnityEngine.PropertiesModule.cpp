...
IL_0017:
	...
	}
	{
		...
		NullCheck(L_8);
		bool L_9;
		L_9 = VirtualFuncInvoker0< bool >::Invoke(89, L_8);
		if (L_9)
		{
			goto IL_0044;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TypeUtility__cctor_mFCC4029AD0D2F3FBE3F7117AC485DF687DE409A5 (const RuntimeMethod* method) 
{
	...
	int32_t G_B4_0 = 0;
	{
		...
		L_12 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(130, L_11, ((int32_t)40));
		V_0 = L_12;
		V_1 = 0;
		goto IL_00b5;
	}
...
IL_0199:
	{
		...
		NullCheck(L_62);
		bool L_63;
		L_63 = VirtualFuncInvoker0< bool >::Invoke(45, L_62);
		V_17 = L_63;
		bool L_64 = V_17;
		if (!L_64)
		{
...
IL_01dc:
	{
		...
		NullCheck(L_76);
		bool L_77;
		L_77 = VirtualFuncInvoker0< bool >::Invoke(48, L_76);
...
IL_0030:
	{
		...
		NullCheck(L_9);
		Type_t* L_10;
		L_10 = VirtualFuncInvoker0< Type_t* >::Invoke(149, L_9);
		___0_type = L_10;
	}
...
IL_003a:
	{
		...
		NullCheck(L_12);
		Type_t* L_13;
		L_13 = VirtualFuncInvoker0< Type_t* >::Invoke(149, L_12);
		il2cpp_codegen_runtime_class_init_inline(Type_t_il2cpp_TypeInfo_var);
		bool L_14;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ReflectedPropertyBagProvider__ctor_mF83A77394EF7205D41A784158583F084E8CE04C2 (ReflectedPropertyBagProvider_tFAAE287D4BED97ACD16EECAEA6DD5DE506D157CF* __this, const RuntimeMethod* method) 
{
	...
	ReflectedPropertyBagProvider_tFAAE287D4BED97ACD16EECAEA6DD5DE506D157CF* G_B1_2 = NULL;
	{
		...
		L_5 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(130, L_4, ((int32_t)20));
...
IL_000f:
	{
		...
		NullCheck(L_3);
		bool L_4;
		L_4 = VirtualFuncInvoker0< bool >::Invoke(48, L_3);
		if (!L_4)
		{
			goto IL_0030;
		}
...
IL_003f_1:
			{
				...
				L_3 = VirtualFuncInvoker1< MemberInfoU5BU5D_t4CB6970BB166E8E1CFB06152B2A2284971873053*, int32_t >::Invoke(120, L_2, ((int32_t)52));
				il2cpp_codegen_runtime_class_init_inline(U3CU3Ec_t6D8C492F99FC36E8E3C273660058AF34514E0523_il2cpp_TypeInfo_var);
...
IL_0248_1:
			...
			}
			{
				...
				NullCheck(L_53);
				Type_t* L_54;
				L_54 = VirtualFuncInvoker0< Type_t* >::Invoke(149, L_53);
				__this->___type = L_54;
